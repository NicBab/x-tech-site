...
const Hero = () => {
  return (
    <section className={`flex bg-primary ${styles.paddingY} ${styles.flexCenter}`}>
      <div className={`xl:px-0 sm:px-16 p-10`}>
       ...
       <div
        className={`flex ${styles.flexCenter} md:my-0 relative p-10`}
      >
     <Image
          src="/X_grey_logo.png"
          alt="logo"
        ...
        <p className="max-w-[400px] min-w-[250px] mt-5">
         ...
         Ready to Optimize Your  Control Systems?
          ...
          <p className="max-w-[400px] min-w-[250px] mt-5">
            ...
            Where dedicated experience meets customer-centric solutions. 
            We focus on your needs to ensure our expertise delivers impactful, tailored results for your business
          </span>
          </p>
