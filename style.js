const styles = {
    ...
    cardHeading: "flex justify-center font-semibold text-[80px] text-black leading-[40px] w-full mt-3",
    cardParagraph: "m-5 font-normal text-black text-[14px] leading-[25px] indent-5",
